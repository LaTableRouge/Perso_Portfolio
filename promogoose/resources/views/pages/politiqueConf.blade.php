...
@section('content')
<article class="politique--container">
    <p class="politique--container-h1">DÉCLARATION DE CONFIDENTIALITÉ</p>
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 1 – RENSEIGNEMENTS PERSONNELS RECUEILLIS</p>

            <p class="politique--container-paragraphe">
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 2 - CONSENTEMENT</p>
            ...
            <p class="politique--container-paragraphe">
                Si après nous avoir donné votre consentement, vous changez d’avis et ne consentez plus à ce que nous puissions vous contacter, recueillir vos renseignements ou les divulguer, vous pouvez nous en aviser en nous contactant à victordianamlnop@gmail.com ou par courrier à: goosestyle 2 rue Bayard, Gap, U, 05000, France
            </p>
        </div>
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 3 – DIVULGATION</p>
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 4 – SHOPIFY</p>
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 5 – SERVICES FOURNIS PAR DES TIERS</p>
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 6 – SÉCURITÉ</p>
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 7 – ÂGE DE CONSENTEMENT</p>
        ...
        <!--  -->
        <div class="politique--container-block">
            <p class="politique--container-h2">ARTICLE 8 – MODIFICATIONS APPORTÉES À LA PRÉSENTE POLITIQUE DE CONFIDENTIALITÉ</p>
